  ...
  return (
    <div className={s.container}>
      <div className={s.center}>
        <h1>
          Welcome to Remote Shop! <br></br>Your Online Shopping Destination
        </h1>
        ...
        <div className={s.desc}>
          <p>
            Remote Shop: Your online shopping haven. Discover, compare, and shop
            with ease. <br></br> Your one-stop destination for all your shopping
            needs! <br></br> Experience the future of shopping, where
            convenience meets choice. <br></br>Your trusted partner in online
            retail
          </p>
        </div>
      </div>
